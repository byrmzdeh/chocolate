        ...
        <div className='servicestwo'>
            <section className="one ">
                ...
                <div className='one-one d-flex align-items-center justify-content-center flex-column ' >
                    <h1>{lang==='en' ? 'Boxed Gift Sweets' : 'Qutuda Hədiyyəlik Şirniyyatlar'}</h1>
                    <p><a href="/">{lang==='en' ? 'Home' : 'Ana Səhifə'} </a> //<a href="/about"> {lang==='en' ? 'About us' : 'Bizim haqqımızda'}</a> // {lang==='en' ? 'Boxed Gift Sweets' : 'Qutuda Hədiyyəlik Şirniyyatlar'}</p>
                </div>
            </section>
